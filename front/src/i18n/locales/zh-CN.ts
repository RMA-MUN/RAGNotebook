const zhCN = {
  ...
  settings: {
    ...
    ai: {
      ...
      apiKey: 'API Key',
      model: 'Model',
      keyHint: '云端必填，本地 Ollama 可留空/填占位符',
      enabled: '启用',
      provider: 'Provider',
      save: '保存',
      saving: '保存中…',
  ...
  graph: {
    ...
    entitiesGroup: '实体',
    notesGroup: '笔记',
    sseConnected: '实时更新已连接',
    sseReconnecting: '实时更新断开，正在重连…',
    truncatedHint: '节点较多，仅显示前 {{count}} 个',
    deleteConfirmTitle: '删除实体',
    deleteConfirmMessage: '确定删除实体「{{name}}」吗？其关系与笔记关联将一并删除。',
    deleteSuccess: '实体已删除',
