const enUS = {
  ...
  settings: {
    ...
    ai: {
      ...
      apiKey: 'API Key',
      model: 'Model',
      keyHint: 'Required for cloud; local Ollama may leave blank/placeholder',
      enabled: 'Enabled',
      provider: 'Provider',
      save: 'Save',
      saving: 'Saving…',
      ...
      reindexHint: 'Re-upload/re-index after changing embedding model',
  ...
  graph: {
    ...
    sseReconnecting: 'Live updates disconnected, reconnecting…',
    truncatedHint: 'Showing first {{count}} nodes only',
    deleteConfirmTitle: 'Delete entity',
    deleteConfirmMessage: 'Delete entity "{{name}}"? Its relations and note links will be removed too.',
